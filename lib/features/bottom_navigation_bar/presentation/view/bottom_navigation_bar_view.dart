            ...
            bottomNavigationBar: NavigationBar(
              ...
              destinations: [
                NavigationDestination(
                  icon: cubit.bottomNavIndex == 0
                      ? SvgPicture.asset(AppIcons.exploreIcon)
                      : SvgPicture.asset(AppIcons.unSelectedExploreIcon),
                  label: LocaleKeys.Home_Explore.tr(),
                ),
                NavigationDestination(
                  icon: cubit.bottomNavIndex == 1
                      ? SvgPicture.asset(AppIcons.resultIcon)
                      : SvgPicture.asset(AppIcons.unSelectedResultIcon),
                  label: LocaleKeys.Result_Result.tr(),
                ),
                NavigationDestination(
                  icon: cubit.bottomNavIndex == 2
                      ? SvgPicture.asset(AppIcons.profileIcon)
                      : SvgPicture.asset(AppIcons.unSelectedProfileIcon),
